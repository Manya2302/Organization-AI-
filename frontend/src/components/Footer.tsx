    ...
    <footer className="relative bg-dark-bg border-t border-dark-border overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-2">
              <a href="mailto:hello@cognivault.ai" className="flex items-center gap-2 text-[13px] text-slate-400 hover:text-blue-400 transition-colors">
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[13px] text-slate-500">© 2025 CogniVault AI. All rights reserved.</p>
